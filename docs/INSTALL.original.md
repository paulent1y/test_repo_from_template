...
Run the app. Console should show:

```
[INFO] app/app.start {session: session-2026-04-26-100000}
```

On non-web: check `logs/` exists in the application support directory.
...
No configuration needed. File writes are automatically skipped. Ring buffer available:
...
See `docs/LOGGING_GUIDE.md` for the full schema, vocabulary, and Claude debugging workflow.
